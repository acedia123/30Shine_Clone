...
export default function AddCourse() {
    ...
    const handleSelectStatus = (e) => {
        ...
        setData((preState) => ({ ...preState, public_status: e.target.value }));
    };

    const handleSelectTopic = (e) => {
        setData((preState) => ({ ...preState, category_id: e.target.value }));
    };
    ...
    const handleChangeTextTerm = (event, name, index) => {
        ...
        setData((preState) => ({ ...preState, data: [...newData] }));
    };

    const handleChangeText = (event, name) => {
        setData((preState) => ({ ...preState, [name]: event.target.value }));
    };

    const handleBlueText = () => {
        setDataError((preState) => ({ ...preState, course_name: checkCourseName(data) }));
    };

    const handleBlurPassword = () => {
        setDataError((preState) => ({ ...preState, password: checkPassword(data) }));
    };
    ...
    const handleBlurTermText = (termIndex) => {
        ...
        setDataError((preState) => ({ ...preState, terms: dataErrors }));
    };
    ...
    const handleCheckValidate = () => {
        ...
        setDataError((preState) => ({ ...preState, ...newState }));
    };
